...
public class SHA256HashingTest {
    ...
    public void testHashPasswordWithSaltReturnsConsistentResult() throws Exception {
        ...
        String hashedPassword1 = SHA256Hashing.hashPasswordWithSalt(TEST_PASSWORD, salt);
        String hashedPassword2 = SHA256Hashing.hashPasswordWithSalt(TEST_PASSWORD, salt);
    ...
    public void testHashPasswordWithRandomSaltReturnsNonNullNonEmptyString() throws Exception {
        ...
        String hashedPassword = SHA256Hashing.hashPassword(TEST_PASSWORD);
    ...
    public void testHashPasswordGeneratesUniqueHashes() throws Exception {
        ...
        String hashedPassword1 = SHA256Hashing.hashPassword(TEST_PASSWORD);
        String hashedPassword2 = SHA256Hashing.hashPassword(TEST_PASSWORD);
    ...
    public void testVerifyHashedPassword() throws Exception {
        ...
        String storedHash = SHA256Hashing.hashPasswordWithSalt(TEST_PASSWORD, salt);
        boolean isVerified = SHA256Hashing.verifyPassword(TEST_PASSWORD, storedHash, salt);
