...
public class SHA512HashingTest {
    ...
    public void testHashPasswordWithSaltReturnsConsistentResult() throws Exception {
        ...
        String hashedPassword1 = SHA512Hashing.hashPasswordWithSalt(password, salt);
        String hashedPassword2 = SHA512Hashing.hashPasswordWithSalt(password, salt);
    ...
    public void testHashPasswordWithRandomSaltReturnsNonNullNonEmptyString() throws Exception {
        ...
        String hashedPassword = SHA512Hashing.hashPassword(password);
    ...
    public void testHashPasswordGeneratesUniqueHashes() throws Exception {
        String password = "TestPassword123";
        String hashedPassword1 = SHA512Hashing.hashPassword(password);
        String hashedPassword2 = SHA512Hashing.hashPassword(password);
