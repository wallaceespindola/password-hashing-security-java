...
public class SHA512HashingTest {
    ...
    public void testHashPasswordWithSaltReturnsConsistentResult() throws Exception {
        ...
        String hashedPassword1 = SHA512Hashing.hashPasswordWithSalt(TEST_PASSWORD, salt);
        String hashedPassword2 = SHA512Hashing.hashPasswordWithSalt(TEST_PASSWORD, salt);
    ...
    public void testHashPasswordWithRandomSaltReturnsNonNullNonEmptyString() throws Exception {
        ...
        String hashedPassword = SHA512Hashing.hashPassword(TEST_PASSWORD);
    ...
    public void testHashPasswordWithRandomSaltReturnsExpectedLength() throws Exception {
        ...
        int expectedLength = Base64.getEncoder().encode(new byte[64]).length;
    ...
    public void testHashPasswordGeneratesUniqueHashes() throws Exception {
        ...
        String hashedPassword1 = SHA512Hashing.hashPassword(TEST_PASSWORD);
        String hashedPassword2 = SHA512Hashing.hashPassword(TEST_PASSWORD);
    ...
    public void testVerifyHashedPassword() throws Exception {
        ...
        String storedHash = SHA512Hashing.hashPasswordWithSalt(TEST_PASSWORD, salt);
        boolean isVerified = SHA512Hashing.verifyPassword(TEST_PASSWORD, storedHash, salt);
